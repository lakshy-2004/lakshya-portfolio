...
const socialLinks = [
    ...
    },
    {
      ...
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-discord" viewBox="0 0 16 16">
    ...
    return (
        ...
        >
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col mr-2">

                    <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
                        Contact me 
                    </h2>
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                    Get in touch today to explore ideas and kickstart something great together!
                    </p>
                ...
                <form 
                action="https://getform.io/f/allyxdna"
                method="POST"
                ...
                >
                    ...
                    <button 
                    type="submit" 
                    className="btn btn-primary btn-primary-submit [&]:max-w-full w-full justify-center reveal-up"
                    >
                        Submit
                    </button>
                </form>
